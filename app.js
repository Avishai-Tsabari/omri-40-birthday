...
(function () {
  ...
  */
  ...
  function init() {
    ...
    /* מצב בדיקות נדלק לבד כשמריצים מקומית. ככה אפשר לבדוק את
       הכל בלי לגעת ב-config.js — ובלי הסיכון לשכוח את testMode
       דלוק בענן ולשלוח לעומרי אתר עם כפתורי דילוג. */
